...
fun main() {
     ...
     */
    hero.setProfile("Shofi Siti Fatimah", 20, 165)
    ...
    **/
     ...
     *
     */
    val uprisingMoonIntelligent = Hero()
    uprisingMoonIntelligent.setProfile("Uprising Moon Intelligent", 20, 165)

    for (i in 1..5) uprisingMoonIntelligent.jalan()
    for (i in 1..2) uprisingMoonIntelligent.lari()
    for (i in 1..3) uprisingMoonIntelligent.makan()
    uprisingMoonIntelligent.minum()
    for (i in 1..3) uprisingMoonIntelligent.lompat()
    uprisingMoonIntelligent.duduk()
     ...
     *
     */
    uprisingMoonIntelligent.profile()
